...
public:
    ...
    Story() : Activity(),
        ...
        titleText(Element(ivec2(20, 30), TGUI_AUTO, TGUI_AUTO), 
                  String("\"The Wonderful Wizard of Oz\""), 
                  TFT_GOLD, 1, 1, 2.5f, &FreeSansBold12pt7b),
        textBox(Element(ivec2(10, 80), TGUI_AUTO, ivec2(300, 180)), 
                TFT_WHITE, TFT_DARKCYAN, true, false, 3),
        storyText(Element(ivec2(10, 80), TGUI_AUTO, ivec2(300, 180), true, true),
                  String(
                      "============================\n"
        ...
        footerText(Element(ivec2(200, 280), TGUI_AUTO, TGUI_AUTO), 
                   String("- Page 1 -"), 
